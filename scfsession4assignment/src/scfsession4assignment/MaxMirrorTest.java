...
public class MaxMirrorTest {
	...
	public static Collection<Object[]> data() {                           //contains data for testing maxMirror
		return Arrays.asList(new Object[][] {
				{ 3, new int[] { 1, 2, 3, 8, 9, 3, 2, 1 } },
				{ 4, new int[] { 1, 1, 2, 2, 2, 2 } },
				{ 2, new int[] { 1, 1, 2, 2, 3, 3 } },
				{ 5, new int[] { 1, 1, 1, 1, 1 } },
			//	{ 7, new int[] { 1, 2, 3, 8, 9, 3, 2, 1 } },    //negative case
				{ 5, new int[] { 1, 2, 3, 2, 1 } },
	...
	assertEquals(expectedResult, arrOperations.sizeMaxMirror(inputArray));    //check if actual is equal to expected
	}
}