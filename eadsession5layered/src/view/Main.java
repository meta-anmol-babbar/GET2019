...
public class Main {
	...
	public Main() {
		...
		while (true) {
			...
			switch (option) {
			case 1:
				List<Products> productsList = Factory.getProductsController()
						.getProducts();
				System.out.format("\n%5s%20s%20s%20s\n", "Product Code",
			...
			case 2: {
				...
				String message = Factory.getCartController().addProductToCart(
						productCode, 1);
				System.out.println("\n" + message);
				break;
			}
			...
			case 3:
				...
				case 1: {
					System.out
							.print("Enter product code to delete product from cart : ");
					int productCode = sc.nextInt();
					String message = Factory.getCartController()
				...
				case 2: {
					System.out
							.print("Enter product code to update its quantity from cart : ");
					int productCode = sc.nextInt();
					System.out
							.print("Enter product quantity to update cart : ");
			...
			case 4: {
				List<Cart> cartItemsList = Factory.getCartController()
						.getCart();
				System.out.format("\n%10s%20s%20s\n", "Product Code",
				...
				System.out.println("Total cart amount : "
						+ Factory.getCartController().getCartValue());
				System.out
						.println("-------------------------------------------------------------");
				break;
			}
