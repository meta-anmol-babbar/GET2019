...
function registerationForm() {
    ...
    document.body.style.backgroundColor = "#62a9c4";
...
function vehicleForm() {
    ...
    document.body.style.backgroundColor = "#c7a277";
...
function validatePassword() {
    ...
    if (employeePassword.length < 6) {
        ...
        return false;
    } else if (!(/(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{7,}/.test(employeePassword))) {
...
function onBlurForm2() {
    ...
    switch (currentField) {
        ...
        case "vehName":
            ...
            label.innerHTML = " What Is The Type Of " + vehicleName;
