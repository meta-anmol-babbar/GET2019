	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		// build HTML code
			...
			htmlRespone += "<body> "
					...
					+ "<tr>"
					+ "<td> Student Id </td>"
					+ "<td><input type= text name=studentId id=stuId readonly value ="+ studentId +"> </td>"
					+ "</tr><tr>"
					+ "<td> First Name </td>"
					+ "<td><input type= text name=firstName id=fname value ='"+ fName +"'></td>"
					+ "</tr><tr>"
					+ "<td> Last Name</td>"
					+ "<td><input type= text name=lastName id=fname value ='"+ lName +"'></td>"
					+ "</tr><tr>"
					+ "<td> Father's Name </td>"
					+ "<td><input type= text name=fatherName id=fathername value ='"+ fatherName +"'></td>"
					+ "</tr><tr>"
					+ "<td> Class </td>"
					+ "<td><input type= text name=studentClass id=stuClass value ='"+ studentClass +"'></td>"
					+ "</tr><tr>"
					+ "<td> Age </td>"
					+ "<td><input type= text name=studentAge id=studentAge value ='"+ age +"'></td>"
					+ "</tr><tr>"
