...
public class MolecularMassCalculator {
	...
	/**
	 * This method is used to calculate molecular mass of any compound
	...
	public int calculateCompoundMass(String compound) {
		...
		for (int i = 0; i < compound.length(); i++) {
			...
			if (MolecularMass.massMap.keySet().contains(ch)){
				//put mass of molecule in stack
				stack.push(MolecularMass.massMap.get(ch).toString());
			}
