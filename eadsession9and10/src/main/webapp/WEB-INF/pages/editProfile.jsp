...
<body>
	...
	<div class="container">
		<form:form modelAttribute="employeeCommands">
			...
			<div class="form-group">
				...
				<form:input type="email" path="email" cssClass="form-control"
					id="email" placeholder="Enter Your email Address" readonly="true" />
			...
			<div class="form-group">
				...
				<form:input path="confirmPassword" type="password"
					cssClass="form-control" id="confirm_password"
			...
			<div class="form-group">
				...
				<form:input path="phoneNumber" type="number" cssClass="form-control"
					id="exampleInputEmail1" placeholder="your mobile number" />
